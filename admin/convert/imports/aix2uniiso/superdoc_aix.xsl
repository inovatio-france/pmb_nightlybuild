...
****************************************************************************************
$Id: superdoc_aix.xsl,v 1.8 2024/08/28 14:02:08 rtigero Exp $ -->
		...
		<s c='v'>
			<xsl:choose> <!-- numero -->
				<xsl:when test="normalize-space(./inm:No-collection)=''">
					<xsl:choose>
						<xsl:when test="(normalize-space(./inm:Volume)!='') or (normalize-space(./inm:Numero-Revue)!='')">
							<xsl:if test="./inm:Volume!=''">
