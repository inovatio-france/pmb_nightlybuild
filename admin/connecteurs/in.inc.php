...
// +-------------------------------------------------+
// $Id: in.inc.php,v 1.35 2023/09/01 12:44:08 qvarin Exp $
...
switch ($act) {
    ...
    case "update":
        if ($id) {
            ...
            $classname = $contrs->catalog[$id]["NAME"];
            $conn = new $classname("{$base_path}/admin/connecteurs/in/{$contrs->catalog[$id]["PATH"]}");
