...
class google_book extends connector {
	...
	public function getEnrichmentHeader(){
		...
		$header[]= "<script type='text/javascript' src='https://www.google.com/books/jsapi.js'></script>";
		$header[]= "<script type='text/javascript'>google.books.load({'language': '".substr($lang,0,2)."'});</script>";
		return $header;
	}
