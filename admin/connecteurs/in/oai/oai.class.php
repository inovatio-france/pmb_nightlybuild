...
// +-------------------------------------------------+
// $Id: oai.class.php,v 1.59 2024/07/11 08:00:09 dbellamy Exp $
...
class oai extends connector {
	...
	/**
	 * Récupération  des proprietes globales par defaut du connecteur (timeout, retry, repository, parameters)
	 */
