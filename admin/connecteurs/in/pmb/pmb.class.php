...
// +-------------------------------------------------+
// $Id: pmb.class.php,v 1.28 2023/08/28 14:04:13 tsamson Exp $
...
class xml_dom_pmb {
	 ...
	 * @return array Noeud correspondant au chemin ou \b false si non trouvé
	 ...
	 * @param array $node Noeud duquel récupérer les données
	 ...
	 * @param array $node Noeud élément duquel on veut les attributs
	 ...
	 * @param string $path chemin du noeud recherché
	 * @param array $node Noeud de départ de la recherche
