...
// +-------------------------------------------------+
// $Id: frame_facture.php,v 1.37 2023/08/02 07:36:47 dbellamy Exp $
...
function show_lig_bak() {
	global $frame_modif, $frame_row, $frame_row_fa_header, $frame_row_fa, $select_typ, $select_rub;
	global $id_cde, $id_fac;
	global $max_lig, $max_lig_fac;
...
function update_fac($statut=0) {
	global $id_cde, $id_fac, $comment, $ref;
