...
// +-------------------------------------------------+
// $Id: UrlBuilder_6_604.php,v 1.3 2023/02/24 11:05:39 qvarin Exp $
namespace Pmb\CMS\Library\UrlBuilder;

class UrlBuilder_6_604 extends UrlBuilder_6_601
{
    ...
    protected function getQuery(): string
    {
        ...
        return "SELECT notice_id AS 'entity_id' FROM notices {$acces_join} WHERE niveau_biblio = 'a' AND niveau_hierar = '2'";
    }
}