...
// +-------------------------------------------------+
// $Id: OpenIDConnectClient.php,v 1.3 2024/02/14 10:45:42 tsamson Exp $
...
if (stristr($_SERVER['REQUEST_URI'], basename(__FILE__))) {
   ...
   /**
    ...
    class OpenIDConnectClient
    {
         ...
         */
        protected $wellKnownConfigParameters = [];
         ...
         */
        protected $privateKeyJwtGenerator;
        ...
        public function checkSignatures($chk = true) {
            $this->checkSignatures = $chk;
        }
