...
// +-------------------------------------------------+
// $Id: abts_modeles.class.php,v 1.50 2023/12/20 08:26:49 dgoron Exp $
	...
	public function show_form() {
		...
		for ($j=0;$j<3;$j++) {
			...
			for ($i=0; $i<15; $i++) {
				...
				$days_v.="<td><input type='checkbox' value='".($j*(15)+$i+1)."' ".(!$tmp && $this->modele_id ? "checked" : "yes")." name='day_month[".($j*(15)+$i+1)."]'/></td>";
			}
			$days_v.="</tr>";
			$days_t.="</tr>";
			$day_month.=$days_t."\n".$days_v."\n";
