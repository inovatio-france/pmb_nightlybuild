...
// +-------------------------------------------------+
// $Id: interface_entity_collection_form.class.php,v 1.1 2021/05/12 14:08:33 dgoron Exp $
...
class interface_entity_collection_form extends interface_entity_authority_form {
	
	protected function get_function_name_check_perso() {
		return 'check_perso_collection_form';
	}
	...
	protected function get_statuses_selector() {
		return authorities_statuts::get_form_for(AUT_TABLE_COLLECTIONS, $this->num_statut);
	}
	
	protected function get_display_audit_action() {
		return audit::get_dialog_button($this->object_id, AUDIT_COLLECTION);
	}
}