...
// +-------------------------------------------------+
// $Id: demandes.class.php,v 1.82 2024/01/05 15:25:04 dgoron Exp $
...
class demandes {
	...
	public function show_list_form(){
		...
		$form_filtre_demande = str_replace('!!user_input!!',htmlentities(stripslashes(isset($user_input) ? $user_input : ''),ENT_QUOTES, $charset),$form_filtre_demande);
