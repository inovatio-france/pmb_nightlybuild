...
// +-------------------------------------------------+
// $Id: notice_info.class.php,v 1.87 2023/10/27 13:32:14 dgoron Exp $
		...
		if(!isset($this->memo_iconcart)) {
			if($use_opac_url_base) {
				if(isset($_SESSION["cart"]) && in_array($this->notice_id, $_SESSION["cart"])) {
	 				$this->memo_iconcart="<span id='baskets".$this->notice_id."'><a href='#' class=\"img_basket_exist\" title=\"".htmlentities($msg['notice_title_basket_exist'],ENT_QUOTES,$charset)."\"><img src=\"".$opac_url_base."images/basket_exist.png\" border=\"0\" alt=\"".htmlentities($msg['notice_title_basket_exist'],ENT_QUOTES,$charset)."\" /></a></span>";
				} else {
