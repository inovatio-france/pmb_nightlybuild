...
// +-------------------------------------------------+
// $Id: rdf_entities_converter_responsability_authperso.class.php,v 1.3 2022/06/02 14:04:35 tsamson Exp $
...
class rdf_entities_converter_responsability_authperso extends rdf_entities_converter {
    
    protected $table_name = 'responsability_authperso';
    
    protected $table_key = 'id_responsability_authperso';
    
    protected function init_map_fields() {
        $this->map_fields = array_merge(parent::init_map_fields(), array(
            'id_responsability_authperso' => 'http://www.pmbservices.fr/ontology#identifier',
            'responsability_authperso_fonction' => 'http://www.pmbservices.fr/ontology#author_function',
        ));
    ...
    protected function init_foreign_fields() {
        $this->foreign_fields = array_merge(parent::init_foreign_fields(), array(
            'responsability_authperso_author' => array(
                'type' => 'author',
    ...
    public function get_qualification($args = []) {
        ...
        $types_object = [TYPE_AUTHPERSO_RESPONSABILITY];
        ...
        $vedette_composee = new vedette_composee($vedette_id, 'rameau');
