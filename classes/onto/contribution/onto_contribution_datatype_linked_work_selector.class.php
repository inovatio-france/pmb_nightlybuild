...
// +-------------------------------------------------+
// $Id: onto_contribution_datatype_linked_work_selector.class.php,v 1.3 2022/04/05 14:30:33 qvarin Exp $
	    ...
	    if ($values && count($values)) {
	        ...
	        foreach ($values as $order => $data) {
	            ...
	            if (!empty($data["value"])) {
	                ...
	                $work_uri = onto_common_uri::get_new_uri($url_base."linked_work#");
