...
// +-------------------------------------------------+
// $Id: pret_archive.class.php,v 1.4 2024/02/27 15:42:58 dgoron Exp $
...
class pret_archive {
	...
	public static function get_last_return_date($arc_expl_id=0) {
		...
		$query = "SELECT arc_fin FROM pret_archive WHERE arc_expl_id =".$arc_expl_id." AND arc_fin < NOW() ORDER BY arc_fin DESC LIMIT 1";
		$result = pmb_mysql_query($query);
