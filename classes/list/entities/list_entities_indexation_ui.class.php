...
// +-------------------------------------------------+
// $Id: list_entities_indexation_ui.class.php,v 1.3 2024/10/03 08:23:24 dgoron Exp $
...
class list_entities_indexation_ui extends list_entities_ui {
	...
	protected function get_cell_content($object, $property) {
	    ...
	    switch($property) {
	        ...
	        case 'actions':
	            //Voir le détails
	            $content .= "<input type='button' class='bouton_small' value='".htmlentities($msg["see"], ENT_QUOTES, $charset)."' onClick=\"document.location='".static::get_controller_url_base()."&name=".$object->name."'\" >";
	            //Indexer
	            $content .= "<input type='button' class='bouton_small' value='".htmlentities($msg["index"], ENT_QUOTES, $charset)."' onClick=\"document.location='".static::get_controller_url_base()."&name=".$object->name."&action=index'\" >";
	            break;
	        default :
