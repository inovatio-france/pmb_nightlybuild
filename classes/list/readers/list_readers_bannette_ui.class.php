...
// +-------------------------------------------------+
// $Id: list_readers_bannette_ui.class.php,v 1.17 2023/12/21 12:56:36 dgoron Exp $
...
class list_readers_bannette_ui extends list_readers_ui {
	...
	public function get_export_icons() {
		...
		if($this->get_setting('display', 'search_form', 'export_icons')) {
			return "<input type='button' class='bouton' value=\"".$msg['dsi_ban_affect_equation']."\" onclick=\"document.location='".$base_path."/dsi.php?categ=bannettes&sub=pro&suite=affect_equation&id_bannette=".$this->id_bannette."&form_cb=".$form_cb."'\"/>";
		}
		return "";
	}
