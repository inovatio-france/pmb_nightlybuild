...
// +-------------------------------------------------+
// $Id: editor.class.php,v 1.117 2023/07/26 15:07:57 tsamson Exp $
...
class editeur {
	...
	protected function get_content_form() {
		...
		$content_form = str_replace('!!ed_nom!!', htmlentities($this->name,ENT_QUOTES, $charset), $content_form);
		$content_form = str_replace('!!ed_adr1!!', htmlentities($this->adr1,ENT_QUOTES, $charset), $content_form);
		$content_form = str_replace('!!ed_adr2!!', htmlentities($this->adr2,ENT_QUOTES, $charset), $content_form);
		$content_form = str_replace('!!ed_cp!!', htmlentities($this->cp,ENT_QUOTES, $charset), $content_form);
		$content_form = str_replace('!!ed_ville!!', htmlentities($this->ville,ENT_QUOTES, $charset), $content_form);
		$content_form = str_replace('!!ed_pays!!', htmlentities($this->pays,ENT_QUOTES, $charset), $content_form);
		$content_form = str_replace('!!ed_web!!', htmlentities($this->web,ENT_QUOTES, $charset), $content_form);
		
		$content_form = str_replace('!!ed_comment!!', $this->ed_comment, $content_form);
		
		$content_form = str_replace('!!id_fou!!', $this->supplier->id_entite, $content_form);
		$content_form = str_replace('!!lib_fou!!', $this->supplier->raison_sociale, $content_form);
