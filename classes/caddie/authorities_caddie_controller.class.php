...
// +-------------------------------------------------+
// $Id: authorities_caddie_controller.class.php,v 1.48 2024/05/03 07:39:14 dgoron Exp $
        ...
        if (!empty($print_cart)) {
            ...
            foreach ($print_cart as $key => $cart_type) {
                ...
                foreach ($cart_type["classement_list"] as $keyBis => $cart_typeBis) {
                    $contenu.=gen_plus($key . $keyBis, $cart_typeBis["title"], "<table style='border:0px; border-spacing: 0px; width:100%' class='classementGen_tableau'>".$cart_typeBis["cart_list"]."</table>", 1);
                }
