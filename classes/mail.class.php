...
// +-------------------------------------------------+
// $Id: mail.class.php,v 1.34 2023/12/28 14:26:57 dgoron Exp $
...
class mail {
	...
	protected function loadContext()
	{
	    ...
	    $this->display_errors = $pmb_display_errors;

	    $this->mail_html_format = $pmb_mail_html_format;
	    $this->mail_adresse_from = $pmb_mail_adresse_from;
	    ...
	    $this->mail_method = $this->formatMailMethodParameters($pmb_mail_methode);
