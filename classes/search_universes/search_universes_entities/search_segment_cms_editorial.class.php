...
// +-------------------------------------------------+
// $Id: search_segment_cms_editorial.class.php,v 1.2 2023/05/04 09:36:38 gneveu Exp $
...
class search_segment_cms_editorial
{
    ...
    {
        $values_section = static::get_value_form_form(TYPE_CMS_SECTION);
        $values_article = static::get_value_form_form(TYPE_CMS_ARTICLE);
        return [
    ...
    protected static function get_value_form_form($type)
    {
