...
// +-------------------------------------------------+
// $Id: cms_module_common_datasource_articles_by_categories.class.php,v 1.3 2022/09/06 07:52:18 gneveu Exp $
	...
	public function get_datas(){
		...
		if ($selector && $selector->get_value()) {
			...
			if ($this->paging && isset($this->parameters['paging_activate']) && $this->parameters['paging_activate'] == "on") {
			    ...
			    $return['articles'] = $this->cut_paging_list($return['articles'], $return["paging"]);}else if ($this->parameters["nb_max_elements"] > 0) {
