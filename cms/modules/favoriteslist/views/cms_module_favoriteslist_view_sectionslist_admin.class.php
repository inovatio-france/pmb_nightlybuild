...
// +-------------------------------------------------+
// $Id: cms_module_favoriteslist_view_sectionslist_admin.class.php,v 1.2 2022/07/19 09:50:48 tsamson Exp $

if (stristr($_SERVER['REQUEST_URI'], ".class.php")) die("no access");

class cms_module_favoriteslist_view_sectionslist_admin extends cms_module_common_view_sectionslist{
	
    private $additional_data = [];
    
    public function __construct($id=0){
        parent::__construct($id);
        $this->default_template = "{% include './includes/templates/cms/modules/favoriteslist/cms_module_favoriteslist_view.tpl.html'%}";
    }
