...
// +-------------------------------------------------+
// $Id: main.inc.php,v 1.2 2022/01/18 09:44:24 qvarin Exp $
    	...
    	default:
    		switch ($what) {
    			case 'save' :
    				...
    				print '<script type="text/javascript">document.location="'.$base_path.'/admin.php?categ=plugin&plugin=animation&sub=animation_conf&what=updated";</script>';
    				break;
    			case 'updated' :
