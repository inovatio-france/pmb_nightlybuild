...
class ARC2_Store extends ARC2_Class
{
    ...
    public function hasHashColumn($tbl)
    {
        ...
        if (!isset($this->$var_name)) {
            ...
            /* BT - Début de correction du problème de maj */
            ...
            /* BT - Fin de correction du problème de maj */
        }
    ...
    public function getTermID($val, $term = '', $dont_cache = false)
    {
        /* mem cache */
        ...
        if ($dont_cache == false && (strlen($val) < 100)) {
