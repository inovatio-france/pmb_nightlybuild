...
// +-------------------------------------------------+
// $Id: explnum.inc.php,v 1.149 2024/10/14 12:11:36 dbellamy Exp $
...
function show_explnum_per_notice($no_notice, $no_bulletin, $link_expl = '', $param_aff = array(), $return_count = false, $context_dsi_id_bannette = 0)
{
    ...
    if ($nb_ex) {
        ...
        while (($expl = pmb_mysql_fetch_object($res))) {
            ...
            if ($i == 1)
                $ligne = "<tr><td id='explnum_" . $expl->explnum_id . "' class='docnum center' width='25%'>!!1!!</td><td class='docnum center' width='25%'>!!2!!</td><td class='docnum center' width='25%'>!!3!!</td><td class='docnum center' width='25%'>!!4!!</td></tr>";
            $tlink = '';
            if ($link_expl) {
