...
// +-------------------------------------------------+
// $Id: options_date_inter.php,v 1.4 2021/05/10 07:03:49 dgoron Exp $
...
require_once ("$class_path/options/options_date_inter.class.php");

options_controller::set_model_class_name('options_date_inter');
