...
// +-------------------------------------------------+
// $Id: cart.tpl.php,v 1.76 2024/07/23 13:11:24 dgoron Exp $

if (stristr($_SERVER['REQUEST_URI'], ".tpl.php")) die("no access");

global $quelle, $include_path, $cart_content_form, $msg, $current_module, $liaison_tpl, $pmb_rfid_activate, $pmb_rfid_serveur_url, $rfid_port, $expl_cb_caddie_tmpl, $begin_result_expl_liste_unique, $cart_procs_form, $cart_proc_view_remote, $notice_linked_suppr_form, $bull_liked_suppr_form, $cart_choix_quoi, $cart_choix_quoi_not_ou_dep, $cart_choix_quoi_action, $cart_transfert_not_movable_expl_table, $cart_choix_quoi_exporter, $cart_choix_quoi_edition, $cart_choix_quoi_impr_cote, $cart_transfert_not_movable_expl_table_line;
global $cart_action_dojo_selector, $cart_action_dojo_selector_line, $cart_action_selector, $cart_action_selector_line;
...
$cart_action_dojo_selector_line = '
...
<span>
    <select style="width:40%" onchange="document.location.href=this.value">
        <option>'.$msg["caddie_menu_action"].'</option>
        !!cart_action_selector_lines!!
    </select>
<span>
';
...
<option value="!!cart_action_selector_line_location!!">!!cart_action_selector_line_msg!!</option>';
