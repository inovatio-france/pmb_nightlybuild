...
// +-------------------------------------------------+
// $Id: thumbnail.tpl.php,v 1.7 2024/10/15 09:04:36 gneveu Exp $
...
const tabTokens_thumbnail = " . json_encode($collectionCSRF->getArrayTokens()) . ";
function chklnk_f_thumbnail_url(element){
	if(element.value != ''){
		...
		var csrf_token = tabTokens_thumbnail[0];
		tabTokens_thumbnail.splice(0, 1);
