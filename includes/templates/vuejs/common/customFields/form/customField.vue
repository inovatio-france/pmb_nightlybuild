<template>
	<div class="row">
		...
		<customfieldsurl v-if="field.type == 'url'" :field="field" :values="values" :img="img" :csrftokens="csrftokens"></customfieldsurl>
...
<script>
	...
	export default {
		props : ["field", "values", "customprefixe", "img", "pmb", "index", "csrftokens"],
