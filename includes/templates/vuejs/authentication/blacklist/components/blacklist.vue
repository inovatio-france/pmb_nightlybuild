<template>
    <div>
        <h2>{{ messages.get("authentication", "auth_blacklist") }}</h2>
...
export default {
    ...
    methods: {
        ...
        changePage(page) {
            document.location = "./admin.php?categ=auth&sub=blacklist&page=" + page;
        }
    }
}
</script>