...
// +-------------------------------------------------+
// $Id: index.tpl.php,v 1.40 2023/07/03 12:57:15 jparis Exp $
...
$login_form .= "
    ...
    //}
		...
		<!--    Bouton d'envoi    -->
	    <div class='row'>
	        <input type='submit' class='bouton' value='$msg[715]' onclick='send_ajax_login(event)' />
	    </div>
	    <div id='error' class='row'>
	        !!erreur!!
	    </div>
      <div id='error-mfa' class='row'>
