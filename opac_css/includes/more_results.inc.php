...
// +-------------------------------------------------+
// $Id: more_results.inc.php,v 1.114 2023/05/04 08:46:18 qvarin Exp $
...
if (
    isset($search_type) &&
    ($search_type == 'tags_search' || ($search_type == 'simple_search' && isset($tags) && $tags == 'ok'))
) {
    if ($search_type == 'simple_search' && $tags == 'ok') {
        global $look_KEYWORDS;
        $look_KEYWORDS = 1;
    }
    rec_history();
