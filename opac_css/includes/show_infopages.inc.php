...
// +-------------------------------------------------+
// $Id: show_infopages.inc.php,v 1.8 2023/08/11 07:08:27 dbellamy Exp $
...
function show_infopages( $infopagesid = "" ) {
	...
	$t_infopagesid = array_map("intval", explode(",", $infopagesid));
	$infopagesid = implode(',', $t_infopagesid);
