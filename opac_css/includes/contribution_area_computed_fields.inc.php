...
// +-------------------------------------------------+
// $Id: contribution_area_computed_fields.inc.php,v 1.3 2024/05/06 08:35:15 tsamson Exp $
...
global $what, $entity_id, $entity_type, $area_id, $action;
$return = array();
...
switch ($what) {
	...
	case 'get_fields':
	default:
	    if (empty($area_id) && !empty($action) && $action == "edit_entity") {
