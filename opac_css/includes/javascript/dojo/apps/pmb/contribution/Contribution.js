...
// +-------------------------------------------------+
// $Id: Contribution.js,v 1.31 2024/05/06 08:35:15 tsamson Exp $
	...
	return declare(null, {
		...
		init: function() {
			...
			if (typeof window.computedFieldsStore == 'undefined') {
				...
				window.computedFieldsStore = new ComputedFieldsStore({areaId: params.area_id, action : params.action});
			}
