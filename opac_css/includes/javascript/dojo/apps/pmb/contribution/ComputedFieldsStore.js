...
// +-------------------------------------------------+
// $Id: ComputedFieldsStore.js,v 1.21 2024/05/06 08:35:15 tsamson Exp $
...
define([
	...
	return declare(Memory, {
		...
		constructor: function() {
			...
			request.get('ajax.php?module=ajax&categ=contribution&sub=computed_fields&what=get_fields&area_id='+this.areaId+'&action='+this.action, {
				handleAs: 'json',
				sync: true
