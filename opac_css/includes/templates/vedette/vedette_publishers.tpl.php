...
// +-------------------------------------------------+
// $Id: vedette_publishers.tpl.php,v 1.4 2021/01/21 09:42:08 jlaurent Exp $
...
$vedette_publishers_tpl['vedette_publishers_selector_contribution'] = '
<div id="!!caller!!_!!property_name!!_!!vedette_composee_order!!_!!vedette_composee_subdivision_id!!_element_!!vedette_composee_element_order!!_form" class="vedette_composee_element_form contribution_vedette_flex_row">
	...
	<input type="hidden" name="!!caller!!_!!property_name_contribution!![!!vedette_composee_order!!][assertions][author_qualification][elements][!!vedette_composee_subdivision_id!!][!!vedette_composee_element_order!!][type]" value="vedette_publishers" />
...
$vedette_publishers_tpl['vedette_publishers_script_contribution']='
var vedette_publishers = {
	// parent : parent direct du selecteur
	// vedette_composee_subdivision_id : id de la subdivision parente
	// vedette_composee_element_order : ordre de l\'element
	prefix: "["+pmbDojo.messages.getMessage("contribution", "vedette_publishers_placeholder")+"]",
