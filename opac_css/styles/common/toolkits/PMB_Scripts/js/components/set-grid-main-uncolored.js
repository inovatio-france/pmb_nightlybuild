...
// +-------------------------------------------------+
// $Id: set-grid-main-uncolored.js,v 1.2 2024/09/12 09:48:06 pmallambic Exp $ */
// grid test
$(document).ready(function () {
	...
	if (bandeauHasChilds() == false) {
		...
		$("#bandeau").addClass("uk-width-1-4@l uk-width-1-3@m uk-width-1-1 ready");
		$("#main").addClass("uk-width-3-4@l uk-width-2-3@m uk-width-1-1");
