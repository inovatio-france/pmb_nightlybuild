...
// +-------------------------------------------------+
// $Id: animation_conf.tpl.php,v 1.6 2023/06/29 09:26:44 rtigero Exp $
...
<div class='row'>
    <form class='form-".$current_module."'>
        <input type='button' name='".$msg[11]."' class='bouton' value='".$msg[11]."' onclick='document.location=\"./admin.php\"'>
    </form>
</div>
";
