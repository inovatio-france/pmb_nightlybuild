...
// +-------------------------------------------------+
// $Id: cms_module_itemslist_view_carousel_uikit.class.php,v 1.2 2023/12/07 15:02:47 pmallambic Exp $

if (stristr($_SERVER['REQUEST_URI'], ".class.php")) die("no access");

class cms_module_itemslist_view_carousel_uikit extends cms_module_common_view_carousel_uikit {
