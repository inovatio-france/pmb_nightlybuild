...
// +-------------------------------------------------+
// $Id: external.inc.php,v 1.27 2023/08/16 15:22:56 dbellamy Exp $
...
if ($_SESSION["ext_type"]=="multi") {
    ...
    if (!$flag) {
        ...
        if ($nb_result_external) {
            ...
            print "<a href=\"#\" onclick=\"document.external_extended_form.submit(); return false;\">$msg[suite]&nbsp;<img src='".get_url_icon('search.gif')."' style='border:0px' /></a><br /><br />";
        }
    }
} else {
    //Recherche "simple"
        ...
        for ($k=0; $k<count($look_array); $k++) {
            ...
            if (${$look}) {
                ...
                if ($nb_result_partial) {
                    ...
                    print "<a href=\"javascript:document.form_".$look_id[$k].".submit()\">$msg[suite]&nbsp;<img src='".get_url_icon('search.gif')."' style='border:0px' /></a><br />";
                    print "</form>\n";
                }
            }
        }
