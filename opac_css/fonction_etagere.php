...
// +-------------------------------------------------+
// $Id: fonction_etagere.php,v 1.11 2023/08/02 14:04:32 dgoron Exp $
...
$id = intval($id);
print pmb_bidi(affiche_etagere(0, $id, 1, 0, AFF_ETA_NOTICES_BOTH, AFF_ETA_NOTICES_DEPLIABLES_OUI, "./fonction_etagere.php?lvl=etagere_see&id=!!id!!", $liens_opac)) ; 
print "</div>";
