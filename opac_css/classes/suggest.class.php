...
// +-------------------------------------------------+
// $Id: suggest.class.php,v 1.25 2024/03/01 14:05:43 dgoron Exp $
...
// ---------------------------------------------------------------------------------------------------
	...
	public static function get_add_link() {
	    ...
	    if ($opac_show_suggest) {
	        ...
	        if ($opac_resa_popup) {
	            $add_link .= " onClick=\"w=window.open('./do_resa.php?lvl=make_sugg&oresa=popup','doresa','scrollbars=yes,width=600,height=600,menubar=0,resizable=yes'); w.focus(); return false;\"";
	        } else {
	            $add_link .= "onClick=\"document.location='./do_resa.php?lvl=make_sugg&oresa=popup' \" ";
	        }
