...
// +-------------------------------------------------+
// $Id: onto_contribution_datatype_linked_record_selector.class.php,v 1.9 2024/06/25 09:57:23 tsamson Exp $
	        ...
	        foreach ($assertions as $assertion) {
	            switch ($assertion->get_predicate()) {
	                ...
	                case 'http://www.pmbservices.fr/ontology#has_record' :
	                    ...
	                    if (empty($properties["http://www.pmbservices.fr/ontology#is_draft"])) {
							$properties["http://www.pmbservices.fr/ontology#is_draft"] = false;
						}
