...
// +-------------------------------------------------+
// $Id: searcher_records.class.php,v 1.5 2023/07/27 06:57:38 gneveu Exp $
...
class searcher_records extends opac_searcher_generic
{
    ...
    {
        if ($return_query) {
            return $this->aq->get_pert($this->objects_ids, $this->field_restrict, false, $with_explnum, $return_query);
        } else {
            $this->table_tempo = $this->aq->get_pert($this->objects_ids, $this->field_restrict, false, $with_explnum, $return_query);
        }
    }
